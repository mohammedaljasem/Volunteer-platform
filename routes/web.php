...
Route::middleware('auth')->get('/locations/create', [MapController::class, 'create'])->name('locations.create');
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // الصلاحيات
    Route::get('/users/{id}/permissions', [AdminController::class, 'editPermissions'])->name('users.permissions.edit');
    Route::post('/users/{id}/permissions', [AdminController::class, 'updatePermissions'])->name('users.permissions.update');
